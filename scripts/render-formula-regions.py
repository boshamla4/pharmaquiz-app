...
REGIONS = [
    ...
    # ── Q17: Beer-Lambert options A–E (label appears BELOW each formula) ────
    (32, 140,  55, 310,  91, "ch2-q017-opt-a", 1, 17,  "A"),
    (32, 140,  86, 310, 122, "ch2-q017-opt-b", 1, 17,  "B"),
    (32, 140, 119, 310, 153, "ch2-q017-opt-c", 1, 17,  "C"),
    (32, 140, 150, 310, 173, "ch2-q017-opt-d", 1, 17,  "D"),
    (32, 140, 176, 310, 204, "ch2-q017-opt-e", 1, 17,  "E"),

    # ── Q27: Sulfanilamide structure in question body ───────────────────────
    (34,  60, 260, 450, 302, "ch2-q027-body",  1, 27,  "question"),

    # ── Q32: Folic acid question body ───────────────────────────────────────
    (35,  60, 122, 570, 212, "ch2-q032-body",  1, 32,  "question"),
    # Q32 options A–E (structural fragments)
    (35,  60, 218, 470, 291, "ch2-q032-opt-a", 1, 32,  "A"),
    (35,  60, 291, 470, 390, "ch2-q032-opt-b", 1, 32,  "B"),
    (35,  60, 379, 470, 422, "ch2-q032-opt-c", 1, 32,  "C"),
    (35,  60, 421, 470, 470, "ch2-q032-opt-d", 1, 32,  "D"),
    (35,  60, 467, 470, 490, "ch2-q032-opt-e", 1, 32,  "E"),

    # ── Q33: Sulphothiazole question body ───────────────────────────────────
    (35,  60, 537, 490, 573, "ch2-q033-body",  1, 33,  "question"),
    # Q33 options A–E (structural fragments)
    (35,  60, 573, 320, 612, "ch2-q033-opt-a", 1, 33,  "A"),
    (35,  60, 608, 320, 645, "ch2-q033-opt-b", 1, 33,  "B"),
    (35,  60, 645, 320, 683, "ch2-q033-opt-c", 1, 33,  "C"),
    ...
    (37, 110, 494, 330, 533, "ch2-q042-opt-c", 1, 42,  "C"),
    (37, 110, 535, 330, 577, "ch2-q042-opt-d", 1, 42,  "D"),
    (37, 110, 578, 330, 613, "ch2-q042-opt-e", 1, 42,  "E"),
    ...
    (52, 110, 672, 320, 785, "ch2-q139-opt-c", 1, 139, "C"),
